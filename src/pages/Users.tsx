                        ...
                        <div className="block md:hidden space-y-4">
                            {subscriptions.map(sub => {
                                ...
                                return (
                                    <SwipeableCard
                                        key={sub.id}
                                        onSwipeLeft={() => handleDeleteUser(sub.id)}
                                        onSwipeRight={showExtend ? () => handleManualActivate(sub.id) : undefined}
                                        rightActionColor="bg-blue-600"
                                        rightIcon={<span className="text-white font-bold text-xs uppercase tracking-wider">Продлить</span>}
                                    >
                                        <div className="space-y-3">
                                            <div className="flex justify-between items-start">
                                                ...
                                                <span className={`px-2 py-1 rounded text-xs ${sub.type === '3m' ? 'bg-purple-500/10 text-purple-600 dark:text-purple-400' :
                                            ...
                                            <div className="flex justify-between items-center text-sm">
                                                ...
                                                <span className={`px-2 py-1 rounded text-xs ${displayStatus === 'active' ? 'bg-green-500/10 text-green-600 dark:text-green-400' :

...
*/
-- DropIndex
DROP INDEX "PlanConfig_type_key";
...
CREATE TABLE "new_keys" (
    ...
    CONSTRAINT "keys_subscriptionId_fkey" FOREIGN KEY ("subscriptionId") REFERENCES "Subscription" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
